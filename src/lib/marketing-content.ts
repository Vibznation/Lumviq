...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  { question: 'Does Lumviq include payroll?', answer: 'Full-service Lumviq Payroll is currently being prepared. Availability begins after payroll-provider activation and compliance approval. Today, Lumviq records the accounting impact of a pay run \u2014 gross wages, tax withholding and employer taxes reported by your provider. It does not calculate withholding, file returns or perform direct deposit itself.' },
