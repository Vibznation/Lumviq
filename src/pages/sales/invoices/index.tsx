  ...
  return (
    <div>
      <PageHeader
        ...
        actions={[{ label: '+ New Invoice', href: '/sales/invoices/new' }]}
        quickLinks={[
          { label: 'Estimates', href: '/sales/estimates', icon: '📝' },
          { label: 'Recurring', href: '/sales/recurring', icon: '🔁' },
          { label: 'Customers', href: '/sales/customers', icon: '👤' },
          { label: 'Products', href: '/sales/products', icon: '📦' },
          { label: 'Credit Notes', href: '/sales/credit-notes', icon: '↩️' },
          { label: 'Refunds', href: '/sales/refunds', icon: '💵' },
        ]}
      />
